...
class TwoFactorAuth
{
    ...
    function __construct($issuer = null, ITimeProvider $timeprovider = null, $digits = 6, $period = 30, $algorithm = 'sha1', IQRCodeProvider $qrcodeprovider = null, IRNGProvider $rngprovider = null)
    {
        $this->issuer = $issuer;
