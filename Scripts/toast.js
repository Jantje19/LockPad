...
ToastManager.autoOkDismiss = true;
const errorHandler = (...args) => {
	console.error(...args);
	const [val, moreInfo] = args;

	if (val instanceof Error)
		ToastManager.makeText(val.name, val.stack);
	else
		ToastManager.makeText(val, moreInfo);
};

customElements.define('lockpad-toast', LPToast);